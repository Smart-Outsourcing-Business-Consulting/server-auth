...
- Bump `auth_oidc` to `19.0.1.5.0` and document the bounded initiation change.
- Migrate tests from render-time creation to initiation-time creation.

## Verification policy

The user explicitly authorized the Odoo test suite and disposable databases. Use Odoo 19
